--- /dev/null
 b/resources/views/payment_items/create.blade.php
@@
@extends('layouts.app')

@section('title', '入金項目登録')

@section('content')
    <div class="page-header">
        <div>
            <h2 class="page-title">入金項目登録</h2>
            <p class="page-description">家賃・共益費・駐車料など、入金で使う項目を登録します。</p>
        </div>
        <div class="actions">
            <a href="{{ route('payment-items.index') }}" class="button button-secondary">入金項目一覧へ戻る</a>
    ...
    @else
        <div class="card" style="margin-bottom: 16px;">
            <form method="GET" action="{{ route('payment-items.create') }}">
                <div class="form-grid">
        ...
        @if ($selectedBook === null)
            <div class="alert alert-error">入金項目を入力する帳簿を選択してください。</div>
        @else
            @if ($errors->any())
